...
**fuzzuli** consists of two main parts. 
- One of them creates a wordlist dynamically. 
- The other sends the HTTP request and checks the response for backup/sensitive file.
