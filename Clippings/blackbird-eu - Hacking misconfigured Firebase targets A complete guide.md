...
Google [[../Dev, ICT & Cybersec/Dev, scripting & OS/Firebase]] is a **popular back-end application development platform** that provides several built-in components and services, allowing developers to seamlessly build interactive web and mobile applications.
...
We will put our main focus on two services:

1. **Firebase Firestore:** A [NoSQL](../Dev,%20ICT%20&%20Cybersec/Dev,%20scripting%20&%20OS/NoSQL%20101.md) document database for storing and syncing app data in real-time across clients.
...
![](attachments/weak-firebase-1.png)
...
![](attachments/weak-firebase-2.png)
*Example of a misconfigured Firebase Firestore security rule definition*
