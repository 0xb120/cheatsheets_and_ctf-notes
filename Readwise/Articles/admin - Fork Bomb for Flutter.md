...
[Flutter](../../Dev,%20ICT%20&%20Cybersec/Dev,%20scripting%20&%20OS/Flutter.md) is an open-source SDK from Google for developing cross-platform applications. [](https://read.readwise.io/read/01js1ckmgsnny193z3q7337kdc)
It is built on C, C++, Dart, and Skia. [](https://read.readwise.io/read/01js1ckycmmpb9646zc6nwzwvm) and consists of three architectural layers: [](https://read.readwise.io/read/01js1cma9bjd42b7d4zpssw0sh)
...
└── resources.arsc
```
 [](https://read.readwise.io/read/01js1cwefq0y4nxd0bgmnv6mj1)
